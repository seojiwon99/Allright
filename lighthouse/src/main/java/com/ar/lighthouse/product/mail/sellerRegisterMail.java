...
@Service
public class sellerRegisterMail implements sellerMailServiceInter {
    ...
    public MimeMessage creatMessage(String to) throws MessagingException, UnsupportedEncodingException {
        ...
        message.setSubject("[All Right] 신청하신 주문취소가 거절되었습니다."); // 이메일 제목
        ...
        msgg += "<br>";
        msgg += "<p>신청하신 주문은 이미 발송처리되어 취소가 불가능하오니 양해부탁드립니다.</p>";
        msgg += "<br>";
        msgg += "<br>";
        msgg += "<p>감사합니다.</p>";
    ...
    public String sendSimpleMessage(String to) throws Exception {
        ...
        return "success"; // 메일로 사용자에게 보낸 인증코드를 서버로 반환! 인증코드 일치여부를 확인하기 위함 
    }
