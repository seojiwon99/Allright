...
import com.ar.lighthouse.buyp.service.ExchangeVO1;
import com.ar.lighthouse.buyp.service.MyInquiryVO;
import com.ar.lighthouse.buyp.service.ReturnVO1;
...
//	}
	...
	public String ReturnList(Model model, HttpSession session) {
		...
		List<ReturnVO1> returnList = buyerPageService.getReturnList(memberId);
	...
	public String ExchangeList(Model model, HttpSession session) {
		...
		List<ExchangeVO1> exchangeList = buyerPageService.getExchangeList(memberId);
	...
	public ResponseEntity<String> addExchange(@RequestBody ExchangeVO1 excVO, HttpSession session) {
